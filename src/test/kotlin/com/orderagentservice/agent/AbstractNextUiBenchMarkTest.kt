...
abstract class AbstractNextUiBenchMarkTest {
    protected val backBenchList = listOf<List<UiComponentDto>>(
        listOf(
            UiComponentDto(x = 132, y = 288, title = "불고기버거 5200원"),
            UiComponentDto(x = 244, y = 401, title = "치즈버거 4800원"),
            UiComponentDto(x = 392, y = 615, title = "새우버거 5600원"),
            UiComponentDto(x = 118, y = 745, title = "다음으로"),
            UiComponentDto(x = 356, y = 302, title = "코카콜라 1700원"),
            UiComponentDto(x = 276, y = 842, title = "제로 콜라 1800원"),
            UiComponentDto(x = 462, y = 418, title = "취소"),
            UiComponentDto(x = 104, y = 918, title = "사이다 1700원"),
            UiComponentDto(x = 378, y = 531, title = "환타 오렌지 1700원")
        ),
        listOf(
            UiComponentDto(x = 160, y = 320, title = "감자튀김 2500원"),
            UiComponentDto(x = 218, y = 486, title = "어니언링 2800원"),
            UiComponentDto(x = 402, y = 608, title = "치즈스틱 3000원"),
            UiComponentDto(x = 130, y = 736, title = "선택완료"),
            UiComponentDto(x = 368, y = 295, title = "아메리카노 3000원"),
            UiComponentDto(x = 270, y = 858, title = "라떼 3500원"),
            UiComponentDto(x = 455, y = 425, title = "이전으로"),
            UiComponentDto(x = 110, y = 930, title = "핫초코 3200원"),
            UiComponentDto(x = 384, y = 540, title = "아이스티 2800원")
        ),
        listOf(
            UiComponentDto(x = 140, y = 300, title = "콤보A 8900원"),
            UiComponentDto(x = 225, y = 470, title = "콤보B 9900원"),
            UiComponentDto(x = 395, y = 600, title = "콤보C 10900원"),
            UiComponentDto(x = 124, y = 728, title = "담기"),
            UiComponentDto(x = 360, y = 310, title = "물 1000원"),
            UiComponentDto(x = 280, y = 860, title = "오렌지주스 2500원"),
            UiComponentDto(x = 460, y = 420, title = "취소"),
            UiComponentDto(x = 108, y = 920, title = "사이드 추가 0원"),
            UiComponentDto(x = 375, y = 535, title = "케첩 추가 0원")
        ),
        listOf(
            UiComponentDto(x = 152, y = 312, title = "불고기 와퍼 7800원"),
            UiComponentDto(x = 232, y = 482, title = "치킨버거 7400원"),
            UiComponentDto(x = 398, y = 610, title = "더블치즈 9200원"),
            UiComponentDto(x = 120, y = 740, title = "다음 단계"),
            UiComponentDto(x = 362, y = 298, title = "콜라 라지 2200원"),
            UiComponentDto(x = 272, y = 852, title = "콜라 미디엄 1900원"),
            UiComponentDto(x = 458, y = 412, title = "이전"),
            UiComponentDto(x = 106, y = 926, title = "레몬에이드 3200원"),
            UiComponentDto(x = 380, y = 528, title = "밀크쉐이크 3900원")
        ),
        listOf(
        ...
        listOf(
            UiComponentDto(x = 148, y = 318, title = "샐러드 베이컨 7200원"),
            UiComponentDto(x = 212, y = 492, title = "샐러드 치킨 7500원"),
            UiComponentDto(x = 404, y = 610, title = "샐러드 연어 8900원"),
            UiComponentDto(x = 130, y = 746, title = "확인"),
            UiComponentDto(x = 356, y = 304, title = "발사믹 드레싱 0원"),
            UiComponentDto(x = 270, y = 862, title = "시저 드레싱 500원"),
            UiComponentDto(x = 450, y = 418, title = "취소"),
            UiComponentDto(x = 112, y = 932, title = "올리브 추가 700원"),
            UiComponentDto(x = 384, y = 540, title = "크루통 추가 500원")
        ),
        listOf(
            UiComponentDto(x = 140, y = 310, title = "불닭 라이스 6800원"),
            UiComponentDto(x = 226, y = 488, title = "치킨 마요 6500원"),
            UiComponentDto(x = 398, y = 608, title = "참치 마요 6200원"),
            UiComponentDto(x = 122, y = 748, title = "확인"),
            UiComponentDto(x = 362, y = 300, title = "계란 추가 1000원"),
            UiComponentDto(x = 274, y = 860, title = "마요 추가 500원"),
            UiComponentDto(x = 452, y = 420, title = "이전으로"),
            UiComponentDto(x = 108, y = 934, title = "김치 추가 500원"),
            UiComponentDto(x = 380, y = 544, title = "단무지 추가 300원")
        )
    )
